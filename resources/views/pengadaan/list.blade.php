        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="width:15%;">
                        ...
                        <hr>
                        <a class="konfirmasi" href="/hapusGambar/{{$p->id_pengadaan}}"><button class="btn-danger"><i class="fas fa-trash"></i>Hapus</button>
                        @endif
                      ...
                      <td>
                        <a href="/hapusPengadaan/{{$p->id_pengadaan}}" class="konfirmasi">
                          <button class="btn btn-danger"><i class="fas fa-trash" ></i>hapus</button>
                        </a>
                          <button 
                          data-id_pengadaan="{{$p->id_pengadaan}}"
                          data-nama_pengadaan="{{$p->nama_pengadaan}}"
                          data-deskripsi="{{$p->deskripsi}}"
                          data-anggaran="{{$p->anggaran}}" 
                          data-toggle="modal" data-target="#ubahModal" class="btn btn-secondary ubah"><i class="fas fa-edit" >ubah</i></button>
              ...
              <!-- /.card-body -->
              <div class="d-flex justify-content-center">{{$pengadaan->links()}}</div> <!-- //paginate -->
            </div>
            <!-- /.card -->
          </div>
        </div>
...
function formatRupiah(angka,prefix){
 ...
 $(function() {
    ...
    $(document).on("click",".konfirmasi", function(event){
      ...
      var answer = window.confirm("kamu yakin ingin menghapus");
      if(answer){

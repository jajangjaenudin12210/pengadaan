...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <!-- ini akan diclude dari file menu.blade.php -->
      @include('utama.menu')
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>REGISTRASI</h2>
          <p>Daftarkan usaha kamu agar mendapat pengajuan.</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-12 mt-5 mt-lg-0 d-flex align-items-stretch">
            <form action="/regis" method="post" role="form" class="php-email-form">
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  <label for="name">Nomor NPWP</label>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h3>BKPSDM KABUPATEN KARAWANG</h3>
            <p>
              Jl. Jend. A. Yani No. 1 <br>
              Karawang<br>
              Jawa Barata, Indonesia <br><br>

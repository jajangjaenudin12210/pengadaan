                ...
                <table class="table table-hover text-nowrap text-center">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a class="btn btn-primary" target="_blank" href="{{asset(Storage::url($p['proposal']))}}">Lihat Detail</a>
                      </td>
                      <td>
                      ...
                      <td>
                        ...
                        @else
                        <a href="{{asset(Storage::url($p['laporan']))}}" class="btn btn-warning" target="_blank"><i class="fa fa-eye">Lihat Laporan</i></a>
                        @endif
